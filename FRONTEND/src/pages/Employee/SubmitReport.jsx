      ...
      <form className="space-y-4">
        ...
        {attended?.value === "no" && (
          <div>
            ...
            {/* If not attended → STOP form here */}
        ...
        {/* 🔹 ONLY SHOW REST IF ATTENDED YES */}
        {attended?.value === "yes" && (
          <>
            ...
            {reportType?.value === "window" && (
              <div>
                <label className="block font-medium mb-1">Upload Shop Display <span className="text-[#E4002B]">(Multiple Images can be uploaded)</span></label>
