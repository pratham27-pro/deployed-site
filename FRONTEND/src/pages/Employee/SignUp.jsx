...
const SignUp = () => {
  const [workerType, setWorkerType] = useState(""); // "Permanent" | "Contractual"
    ...
    if (workerType === "Permanent") {
      ...
      return {
        ...
        personal: {
          ...
          dob: p_dob,
          phone: p_phone,
          highestQualification: p_highestQualification,
          gender: p_gender,
          maritalStatus: p_maritalStatus,
          fathersName: p_fathersName,
          addressLine1: p_address1,
          addressLine2: p_address2,
          pincode: p_pincode,
        ...
        bank: {
          accountNumber: p_bankAccount,
          ifsc: p_ifsc,
          branchName: p_branchName,
        },
        experiences,
        files: {
          aadhaarFile: p_aadhaarFile?.name || null,
          panFile: p_panFile?.name || null,
          personPhoto: p_personPhoto?.name || null,
        },
      };
    } else {
      // Contractual
      ...
      if (!c_aadhaarFile || !c_personPhoto) {
      ...
      return {
        ...
        personal: {
          name: c_name,
          dob: c_dob,
          addressLine1: c_address1,
          addressLine2: c_address2,
          phone: c_phone,
          aadhaarNumber: c_aadhaar,
          contractLength: c_contractLength,
        },
        files: {
          aadhaarFile: c_aadhaarFile?.name || null,
          panFile: c_panFile?.name || null,
          personPhoto: c_personPhoto?.name || null,
        },
      };
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      // Replace with real API request. For now we log the payload
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 px-4 pt-28 pb-10">
        <div className="max-w-4xl mx-auto bg-white shadow rounded-lg p-6">
          ...
          {/* Worker Type selection (card style, no big icons) */}
          <div className="mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {workerType === "Permanent" && (
              <>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <IconInput
                        ...
                        value={co_pincode}
                        onChange={(e) =>
                          setCoPincode(e.target.value.replace(/\D/g, ""))
                        }
                        maxLength={6}
                      />
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <IconInput
                        ...
                        value={p_pincode}
                        onChange={(e) =>
                          setPPincode(e.target.value.replace(/\D/g, ""))
                        }
                        maxLength={6}
                        disabled={sameAsCorrespondence}
                      />
                ...
                <section className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <IconInput icon={FaUser} placeholder={"Enter father's name"} label="Father's Name" value={p_fathersName} onChange={(e) => setPFathersName(e.target.value)} />
                    <IconInput icon={FaCalendarAlt} label="Father's DOB" type="date" value={p_fatherDob} onChange={(e) => setPFatherDob(e.target.value)} />
                    <IconInput icon={FaUser} placeholder={"Enter mother's name"} label="Mother's Name" value={p_motherName} onChange={(e) => setPMotherName(e.target.value)} />
                    <IconInput icon={FaCalendarAlt} label="Mother's DOB" type="date" value={p_motherDob} onChange={(e) => setPMotherDob(e.target.value)} />
                    <IconInput icon={FaUser} placeholder={"Enter spouse's name"} label="Spouse Name (if applicable)" value={p_spouseName} onChange={(e) => setPSpouseName(e.target.value)} />
                    <IconInput icon={FaCalendarAlt} label="Spouse DOB" type="date" value={p_spouseDob} onChange={(e) => setPSpouseDob(e.target.value)} />
                    <IconInput icon={FaUser} placeholder={"Enter child 1's name"} label="Child 1 Name" value={p_child1Name} onChange={(e) => setPChild1Name(e.target.value)} />
                    <IconInput icon={FaCalendarAlt} label="Child 1 DOB" type="date" value={p_child1Dob} onChange={(e) => setPChild1Dob(e.target.value)} />
                    <IconInput icon={FaUser} placeholder={"Enter child 2's name"} label="Child 2 Name" value={p_child2Name} onChange={(e) => setPChild2Name(e.target.value)} />
                    <IconInput icon={FaCalendarAlt} label="Child 2 DOB" type="date" value={p_child2Dob} onChange={(e) => setPChild2Dob(e.target.value)} />
                  </div>
                </section>
            ...
            {workerType === "Contractual" && (
              <>
                <section className="space-y-4">
                  <h3 className="text-lg font-medium text-[#E4002B]">Contractual Employee Details</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <IconInput
                      icon={FaUser}
                      label="Full Name"
